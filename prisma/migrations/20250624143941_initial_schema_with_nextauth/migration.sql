...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PREPARING', 'READY_FOR_DELIVERY', 'DELIVERED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "users_houseNumber_key" ON "users"("houseNumber");
